...
public class PasswordDaoTest
{
    ...
    /**
     * Test of isInited method, of class PasswordDao.
     */
    @Test
    public void testIsInited() throws IOException
    {
        System.out.println("isInited");
        boolean expResult = false;
        boolean result = PasswordDao.isInited();
        assertEquals(expResult, result);
        PasswordDao.init("test");
        result = PasswordDao.isInited();
        assertEquals(true, result);

    }

    /**
     * Test of checkPassword method, of class PasswordDao.
     */
    @Test
    public void testCheckPassword() throws Exception
    {
        ...
        boolean expResult = false;
        PasswordDao.init("test");
        boolean result = PasswordDao.checkPassword(masterPassword + "1");
        assertEquals(expResult, result);
        result = PasswordDao.checkPassword(masterPassword);
        assertEquals(true, result);
    }
